...
///////////////////////////////////////////////////////////////////////////////////////
void ClusterSet::compSimilarMatches(const ClusterMembershipSet& guass,
	const ClusterMembershipSet& truth, GAmatrix& matches) const {
    ...
    for (i=0; i < sz; ++i, assignToTruth.clear()) {
		matches(i, 0) = guass.similarMatch(truth, EvalIndex::Name(i), assignToTruth);
